		...
		<table class="table table-hover" id="table">
			...
			<tbody>
				...
				<tr>
					<td><?php echo $no ?></td>
					<td>
						<a href="<?=base_url()?>Dosen/History/nilai/<?=$r->id_ujian?>" class="btn btn-primary btn-xs btn-flat xtooltip"> <i class="fa fa-edit fa-fw" style="color:#ffffff;"></i> <span style="color:#ffffff;"> Lihat Nilai</span></a>
					</td>
