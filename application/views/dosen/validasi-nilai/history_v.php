		...
		<table class="table table-hover" id="table">
			...
			<tbody>
				...
				<tr>
					<td><?php echo $no ?></td>
					<td>
						<a href="<?=base_url()?>Dosen/validasi_Nilai/nilai/<?=$r->id_ujian?>" class="btn btn-primary btn-xs btn-flat xtooltip"> <i class="fa fa-edit fa-fw" style="color:#ffffff;"></i> <span style="color:#ffffff;"> Lihat Nilai</span></a>
					</td>
...
<script type="text/javascript">
	...
	swal({
        title: "Done",
        text: "Berhasil Menyetujui Hasil!",
        timer: 1500,
        showConfirmButton: false,
        type: "success"
    });
