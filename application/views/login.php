...
<html><head>
    ...
    <title>LOGIN | SISTEM COMBASED KESEKRETARISAN</title>
    ...
    <link rel="icon" href="<?php echo base_url();?>assets/img/UNIVERSITASTEKNOKRAT.png" />
  </head>
  <body >
    <div class="login-box " >
        <?php 
      ...
      <div class="login-box-body">
        <p class="login-box-msg" style="font-size:18px;">Login Pengguna</p>

        <div id="msg"><?php echo $this->session->flashdata('msg');?></div>
        
        <?php echo validation_errors('<div class="alert alert-danger">', '</div>'); ?>
        <?php echo form_open('Userlogin/auth_log', 'id="loginform"', 'autocomplete="off"'); ?>
