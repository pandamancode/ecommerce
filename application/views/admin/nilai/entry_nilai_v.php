...
<div class="box box-primary with-border">
  ...
  <div class="box-body">
		...
		<table class="table table-hover" id="table">
			...
			<form method="post" action="<?=base_url()?>Administrator/Nilai/store">
			<tbody>
				<?php
				$no =0;
			...
			<tfoot>
				<tr>
					<td colspan="7">
						...
						<a href="<?=base_url()?>Administrator/Nilai" class="btn btn-warning btn-sm"><i class="fa fa-reply"></i><i> Kembali</i></a>
					</td>
				</tr>
			</tfoot>
			</form>
